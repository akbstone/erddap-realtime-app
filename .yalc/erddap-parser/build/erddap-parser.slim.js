(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-fetch'), require('d3-dsv')) :
	typeof define === 'function' && define.amd ? define(['exports', 'd3-fetch', 'd3-dsv'], factory) :
	(global = global || self, factory(global.d3 = global.d3 || {}, global.d3, global.d3Dsv));
}(this, function (exports, d3Fetch, d3Dsv) { 'use strict';
	...
	var erddapParser = {
	  ...
	  parseCSV: function (csvString) {
	    return d3Dsv.csvParse(csvString);
	  },
